...
DECLARE @DropTables bit = 1; /* 1=drops all tables */
DECLARE @DropViews bit = 1; /* 1=drops all views */
DECLARE @DropStoredProcedures bit = 1; /* 1=drops all stored procedures */
DECLARE @DropFunctions bit = 1; /* 1=drops non CLR functions */
DECLARE @DropUserDefinedDataTypes bit = 1; /* 1=drops all user defined data and table types */
DECLARE @DropSequences bit = 1; /* 1=drops all sequences */
DECLARE @DropSynonyms bit = 1; /* 1=drops all synonyms */
